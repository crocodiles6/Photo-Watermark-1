...
public class WatermarkProcessor {
     ...
     * 批量应用水印
     */
    public void batchApplyWatermark(File exportDir) {
        ...
        executorService.submit(() -> {
            ...
            for (ImageFile imgFile : imageFileManager.getImageFiles()) {
                try {
                    ...
                    ImageIO.write(baseImage, extension, outputFile);
                    successCount++;
                } catch (Exception e) {
            ...
            Platform.runLater(() -> {
                ...
                uiUtils.showInfo("批量处理结果", message.toString());
                uiUtils.updateStatus("批量水印处理完成");
            });
        });
    }
